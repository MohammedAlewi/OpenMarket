...
class EditProductFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var fragmentEditProductBinding=
            DataBindingUtil.inflate<FragmentEditProductBinding>(inflater, R.layout.fragment_edit_product, container, false)
...
class EditController(var product: Product,var productViewModel: ProductViewModel,var view:View,var editProductFragment: EditProductFragment){
    fun saveChanges(){
        ...
        if (EditProductFragment.editedProductFields(product)){
            ...
            Toast.makeText(editProductFragment.context,"Please, fill all the required fields",Toast.LENGTH_LONG).show()
        }
