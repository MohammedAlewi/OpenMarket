 ...
 * [ProductUploadFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ProductUploadFragment.newInstance] factory method to
...
class ProductUploadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        adapter.setDropDownViewResource(android.R.layout.ff)
    ...
    companion object {
         ...
         * @return A new instance of fragment ProductUploadFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProductUploadFragment().apply {
